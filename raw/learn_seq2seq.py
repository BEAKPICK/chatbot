...
# 데이터 읽기
# x_train, t_train = preprocessing.load_data(file_name='./dataset/ChatbotData.csv', need_soseos=True)
...
if os.path.isfile("../pkl/myAttentionSeq2seq.pkl"):
    model.load_params("./pkl/myAttentionSeq2seq.pkl")
...
for epoch in range(max_epoch):
    ...
    model.save_params('./pkl/myAttentionSeq2seq.pkl')
